                   ...
                   <?php endif; ?>
                                 ...
                                 <?php if(config_db_item('terms_link') !== FALSE): ?>
                                    ...
                                    <div class="control-group">
                                      ...
                                      <div class="controls">
                                          <input type="checkbox" value="1"> <a target="_blank" href="<?php echo $terms_url; ?>" style="line-height: 24px;vertical-align: top;display: inline-block;"><?php echo lang_check('I accept the Terms and Conditions'); ?></a>
                                      </div>
                                    </div>
                                    <?php endif;?>
                                    ...
                                    <div class="control-group">
                                      ...
                                      <div class="controls" style="">
                                        <input type="checkbox" style=""  value="1" name="privacy_user" class="privacy_user" required="required"> <a target="_blank" href="<?php echo $privacy_url; ?>" style="line-height: 24px;vertical-align: top;display: inline-block;"><?php echo lang_check('I accept the Privacy'); ?></a>
                                      </div>
                                    </div>
                                    <?php endif;?>
