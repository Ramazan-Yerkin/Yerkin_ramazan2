              ...
              <div style="padding-top: 9px;" class="tab-content">
                ...
                <?php endforeach; ?>
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <?php echo form_checkbox('option_privacy_link', 'true', set_value('option_privacy_link', false), 'class="novalidate" required="required" id="inputOption_terms"')?>
                      </div>
                    </div>
                                <?php endif; ?>
