            ...
            destroy: function (e, data) {
                ...
                if (data.url) {
                    $.ajax(data).done(function(json) {
                        ...
                        that._trigger('destroyed', e, json);
