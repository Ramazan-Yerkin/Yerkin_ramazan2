...
<div class="">
    ...
    <!-- MAIN CONTENT -->
     <section class="slice bg-white bb" id="news">
                            ...
                            <!-- <div class="section-title-wr">
                                ...
                                <form class="form-light">
                                    <div class="input-group">
                                        <input type="text" id="search_news" class="form-control" placeholder="<?php _l('Search');?>">
                                        <span class="input-group-btn">
                                            <button id="btn-search_news" class="btn btn-base" type="button"><?php _l('Go');?></button>
                                        </span>
                                    </div>
                                </form>
                            </div> -->
...
<script>
    $(document).ready(function(){
        $("#btn-search_news").click( function() {
